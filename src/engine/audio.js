...
// Turbo voice quip sets, mirroring the original VOICE/_VOICE.TXT groupings.
const VOICE_SETS = {
  start:   ['IFEELTHENEEDFORSPEED', 'FASTERISBETTER', 'FASTERWOULDBEBETTER', 'SPEEDYDELIVERY', 'SOMEBODYCALLFORADELIVERY'],
  ...
  powerup: ['FULLYLOADED', 'HELLINASHELL', 'IMONFIRE', 'IMONFIREBABY', 'IMPACKIN'],
